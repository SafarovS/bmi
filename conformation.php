        ...
        <div class="container">
          <div class="row justify-content-center col-md-12" >
                <div class="col-md-6 shadow">
                  <h4 class="row justify-content-center text-white bg-primary " style="font-family: Times new roman;line-height: 50px;"> Cheking conformation code
                  </h4>
                  ...
                  <div class="alert alert-success col-md-10" style="text-align: center;">
                    <h6> <?php echo $_GET['info']; ?></h6>
                  </div>
                        <?php } ?>
                         
                        <div class="col-md-12 form-group">
                          <label for="username">Code</label>
                            <input type="number" name="code" id="username" class="form-control form-control-lg" required placeholder="Enter conformation code" >
                        </div>
                        <div class="col-md-12 form-group">
                          <input type="submit" name="send" value="Confirmation" class="btn btn-primary btn-lg px-5">
                        </div>
                    </div>
